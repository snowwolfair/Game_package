...
execute as @s if score @s tempnum matches 4 run data modify storage help_msg:test test4 set from entity @e[type=item_frame,distance=..5,limit=1] Item.tag.pages[]
execute as @s if score @s tempnum matches 5 run data modify storage help_msg:test test5 set from entity @e[type=item_frame,distance=..5,limit=1] Item.tag.pages[]
