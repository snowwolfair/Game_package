...
#击杀后给与积分
execute as @a[tag=in_play,team=red] if score @s red_kill_point matches 1 run give @s minecraft:diamond{display:{Name:'{"text":"积分"}',Lore:['{"text":"军事演习唯一指定通用品，需要在军需官处换成货币","color":"purple"}']},Unbreakable:1} 1
#将击杀分数清零，准备下一次计数
